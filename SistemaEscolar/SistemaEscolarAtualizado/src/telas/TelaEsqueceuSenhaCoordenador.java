...
public class TelaEsqueceuSenhaCoordenador {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaEsqueceuSenhaCoordenador window = new TelaEsqueceuSenhaCoordenador();
	 ...
	 */
	public TelaEsqueceuSenhaCoordenador() {
		initialize();
	}
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 316, 355);
		...
		lblNovaSenhaNovamente.setBounds(31, 204, 181, 14);
		...
		botaoRedefinir.setBounds(95, 275, 117, 35);
		frame.getContentPane().add(botaoRedefinir);
		botaoRedefinir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(cpf.getText().isEmpty()|| String.valueOf(senha.getPassword()).isEmpty()|| String.valueOf(senhaRpt.getPassword()).isEmpty()) {
